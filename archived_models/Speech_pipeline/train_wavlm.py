"""
WavLM SPEECH EMOTION RECOGNITION - TRAINING SCRIPT

CORRECT COMMAND TO RUN THIS SCRIPT:
    python archived_models/Speech_pipeline/train_wavlm.py

Run from: Project Root Directory
This script trains the WavLM model and saves results to archived_models/Results/
"""
...
MODEL_SAVE_PATH = os.path.join(ARCHIVED_MODELS_DIR, "Speech_pipeline", "wavlm_random_split.pth")
...
def train_wavlm_pipeline():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_PLOTS_DIR, "wavlm_training_history.png"), dpi=150)
    plt.close()
